...
class ReportController extends Controller
{
    public function list(Request $request)
    {
        ...
        $reports = Report::whereHas('anak', function ($query) use ($orangtua_id) {
    ...
    public function listpertanggal(Request $request, $id)
    {
        $tanggal = $request->tanggal;
        $reports = Report::whereHas('anak', function ($query) use ($id) {
            $query->where('orangtua_id', $id);
        })->whereDate('created_at', $tanggal)->with('mapel', 'anak')->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($dailyreport) {
            return $this->response(TRUE, array('Berhasil menambahkan data daily report'));
        } else {
            return $this->response(FALSE, array('Gagal menambahkan data daily report!'));
        }
    }
