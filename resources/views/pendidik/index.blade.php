        ...
        <tbody class="list">
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              <div class="modal fade" id="modalHapus{{ $pendidik->id }}" data-bs-keyboard="false" data-bs-backdrop="static"
                ...
                <div class="modal-dialog mt-6" role="document">
                  <div class="modal-content border-0">
                    ...
                    <div class="modal-footer">
                      ...
                      <form action="{{ url('pendidik/' . $pendidik->id) }}" method="POST" id="delete{{ $pendidik->id }}">
                        @csrf
                        @method('delete')
                      </form>
                    </div>
